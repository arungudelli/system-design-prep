...
providers; queues absorb fan-out bursts. See [architecture](02-systems/notification-system/architecture.md).
</details>
...
behind a 50M-user campaign, so transactional and bulk are **physically separate** queues/pools. See [prioritization](02-systems/notification-system/deep-dives.md#4-prioritization--fairness-transactional-vs-bulk).
</details>
...
exhaust shared threads. Async ingestion means a provider outage delays, not drops. See [channel abstraction](02-systems/notification-system/deep-dives.md#1-the-channelprovider-abstraction).
</details>
...
dedup the duplicates. See [dedup](02-systems/notification-system/deep-dives.md#3-deduplication-dont-double-notify).
</details>
...
over time. The queues buffer the burst; transactional lanes are untouched. See [capacity](02-systems/notification-system/capacity.md#fan-out-amplification-the-real-scaling-problem).
</details>
...
CAN-SPAM/TCPA). Preferences are cached but invalidated promptly on change. See [preferences](02-systems/notification-system/deep-dives.md#2-user-preferences-quiet-hours--opt-out-product--legal).
</details>
...
secondary. See [retries](02-systems/notification-system/deep-dives.md#5-retries-dlq--failing-providers).
</details>
...
a short buffering window per (user, event-type) or a periodic digest job (via the [job scheduler](02-systems/job-scheduler/README.md)).
...
← Back to **[README](02-systems/notification-system/README.md)** · Next: **[Cheatsheet](02-systems/notification-system/cheatsheet.md)**
