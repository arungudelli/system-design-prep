...
1. **[Requirements](02-systems/notification-system/requirements.md)** — problem, clarifying questions, functional + NFRs
2. **[Capacity](02-systems/notification-system/capacity.md)** — notifications/sec, fan-out, storage
3. **[API & Data Model](02-systems/notification-system/api-data-model.md)** — send API, templates, preferences, device tokens
4. **[Architecture](02-systems/notification-system/architecture.md)** — ingestion → fan-out → channel workers → providers
5. **[Deep Dives](02-systems/notification-system/deep-dives.md)** — channel abstraction, preferences, dedup, prioritization, retries, delivery tracking
6. **[Trade-offs](02-systems/notification-system/tradeoffs.md)** — the decisions, both sides
