...
- **Schedule store** — durable jobs table with the `next_run_at` index (see [data model](02-systems/job-scheduler/api-data-model.md)).
...
- **Why fence_token:** if a slow/paused worker resumes after its lease was reassigned, its writes carry a **stale
  ...
  [exactly-once deep dive](02-systems/job-scheduler/deep-dives.md#2-exactly-once-execution-the-honest-version).
...
→ Next: **[Deep Dives](02-systems/job-scheduler/deep-dives.md)**
