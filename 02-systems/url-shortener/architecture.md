...
Note what's *not* on the list: storage and bandwidth. The numbers ([Capacity](02-systems/url-shortener/capacity.md))
...
**zero coordination on the hot path, zero collisions.** Detailed in [Deep Dives](02-systems/url-shortener/deep-dives.md).
...
→ Next: **[Deep Dives](02-systems/url-shortener/deep-dives.md)**
