...
1. **[Requirements](02-systems/url-shortener/requirements.md)** — problem statement, clarifying questions, functional + NFRs
2. **[Capacity](02-systems/url-shortener/capacity.md)** — the math that decides the architecture
3. **[API & Data Model](02-systems/url-shortener/api-data-model.md)** — endpoints, schema, key-length math
4. **[Architecture](02-systems/url-shortener/architecture.md)** — simplest design → request flows → scaling
5. **[Deep Dives](02-systems/url-shortener/deep-dives.md)** — key generation, caching, 301 vs 302, custom aliases, analytics, expiry
6. **[Trade-offs](02-systems/url-shortener/tradeoffs.md)** — the decisions and both sides of each
