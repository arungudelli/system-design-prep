...
extra write-time lookup. → detail in [Deep Dives](02-systems/url-shortener/deep-dives.md).
...
not popularity.** → [SQL vs NoSQL](03-tradeoffs/sql-vs-nosql.md) *(coming)*.
...
where offload matters more than tracking. → table in [Deep Dives](02-systems/url-shortener/deep-dives.md#3-redirect-301-vs-302-a-genuine-trade-off--expect-a-follow-up).
...
is a stated requirement — and note it's unusually cheap to do here. → [active-active vs active-passive](03-tradeoffs/active-active-vs-active-passive.md) *(coming)*.
...
→ Next: **[Failure Scenarios](02-systems/url-shortener/failure-scenarios.md)**
