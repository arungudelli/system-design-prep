...
>
> Read the base first: [Requirements](02-systems/web-crawler/requirements.md) · [Architecture](02-systems/web-crawler/architecture.md)
> · [Deep Dives](02-systems/web-crawler/deep-dives.md) · [Trade-offs](02-systems/web-crawler/tradeoffs.md).
>
...
- **Design:** shard the Bloom filter + backing KV by `hash(url)`; a **SimHash/MinHash service** for near-dup at
  scale; snapshot for restart. See [dedup base](02-systems/web-crawler/deep-dives.md#2-url-deduplication-the-seen-set).
...
← Back to **[Web Crawler overview](02-systems/web-crawler/README.md)** · Base **[deep dives](02-systems/web-crawler/deep-dives.md)** · **[cheatsheet](02-systems/web-crawler/cheatsheet.md)**
