...
[Deep Dives](02-systems/web-crawler/deep-dives.md#1-the-url-frontier-the-heart-of-the-crawler)).
...
- **Store:** **object storage (S3)** for the raw compressed HTML (big blobs, write-once) +
  ...
  [object storage & CDN](01-patterns/object-storage.md) *(coming)*.
...
→ Next: **[Architecture](02-systems/web-crawler/architecture.md)**
