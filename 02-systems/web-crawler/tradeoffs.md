...
[frontier](02-systems/web-crawler/deep-dives.md#1-the-url-frontier-the-heart-of-the-crawler).
...
crawler; you get billions-scale dedup in gigabytes. → [dedup](02-systems/web-crawler/deep-dives.md#2-url-deduplication-the-seen-set).
...
**Choose:** **adaptive**, using conditional GETs and sitemap `lastmod`. → [freshness](02-systems/web-crawler/deep-dives.md#7-freshness--recrawl-turning-a-one-shot-into-a-living-index).
...
→ Next: **[Failure Scenarios](02-systems/web-crawler/failure-scenarios.md)**
