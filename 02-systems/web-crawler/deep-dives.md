...
billions of URLs — too many to hold as full strings in memory (see [capacity](02-systems/web-crawler/capacity.md#frontier--seen-set-the-interesting-one)).
...
**Normalization first** (see [API & data model](02-systems/web-crawler/api-data-model.md#url-normalization-dont-skip--its-a-dedup-correctness-issue)) — dedup is only as good as your canonical form.
...
→ Next: **[Trade-offs](02-systems/web-crawler/tradeoffs.md)**
