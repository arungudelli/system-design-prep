...
- **Contain:** **per-host URL budget + depth limit + parameter/pattern heuristics + session-id stripping** in
  normalization. Blacklist pathological patterns. (See [traps](02-systems/web-crawler/deep-dives.md#6-crawler-traps--hostile-content-robustness).)
...
→ Next: **[Interview Questions](02-systems/web-crawler/interview-questions.md)**
