...
| [`01-patterns/`](01-patterns/caching.md) | **Caching 🟢** · queues/workers, sharding, idempotency, rate limiting, realtime, object storage, observability, multi-region (planned) | 🟢 building |
...
- [ ] 01 · More patterns (queues/workers, sharding, idempotency…)
- [ ] 02 · Web Crawler
