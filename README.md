...
|---|---|---|
| [`00-framework/`](00-framework/system-design-framework.md) | The 20-step method, capacity math, staff-level thinking, interview wording, checklist | 🟢 building |
...
| `02-systems/` | URL shortener, notifications, chat, web crawler, file storage, YouTube, rate limiter, job scheduler, metrics, news feed, payments, ride-sharing | ⚪ planned |
