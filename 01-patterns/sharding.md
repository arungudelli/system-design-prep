...
- **Need it when:** read-heavy with locality (see [caching](01-patterns/caching.md)).
...
- **Fix:** better shard key; **salt** the hot key (`key#bucket`) to spread it; **split** the hot shard; put a
  **cache** in front of the hot entity (see [caching hot keys](01-patterns/caching.md#3-hot-key)); isolate the
...
- **When you can't:** use the **[saga pattern](01-patterns/idempotency.md)** *(coming)* (a sequence of local
...
← Back to **[patterns](/)** · Related: [caching](01-patterns/caching.md) · [idempotency](01-patterns/idempotency.md) *(coming)*
