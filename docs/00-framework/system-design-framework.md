...
### 5. Estimate scale
Order-of-magnitude only. See **[Capacity estimation](capacity-estimation.md)** for the method.
...
→ Next: **[Capacity estimation](capacity-estimation.md)**
