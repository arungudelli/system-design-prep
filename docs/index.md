...
*Built with [MkDocs Material](https://squidfunk.github.io/mkdocs-material/) — use the top tabs, the left sidebar,
...
<sub>Built with Claude Code · rendered with MkDocs Material · this is a living document — notes get sharper after every mock.</sub>
