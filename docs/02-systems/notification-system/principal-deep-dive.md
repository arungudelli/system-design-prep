...
- **Design:** **digest/aggregation** windows ("10 people liked your post"), **per-user fatigue caps**, and — at the
  ...
  window or the [job scheduler](../job-scheduler/README.md).
...
← Back to **[Notification System overview](README.md)** · Base **[deep dives](deep-dives.md)** · **[cheatsheet](cheatsheet.md)**
