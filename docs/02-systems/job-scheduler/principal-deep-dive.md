...
- **Design:** bucket jobs by fire-time (`bucket = floor(next_run_at / granularity)`); shard buckets across nodes;
  ...
  onto Redis sorted sets per bucket or partitioned tables. See [finding due jobs](deep-dives.md#1-finding-what-is-due-efficiently).
...
← Back to **[Job Scheduler overview](README.md)** · Base **[deep dives](deep-dives.md)** · **[cheatsheet](cheatsheet.md)**
